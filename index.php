...
if (isset($_GET['ulozit'])) {
    ...
    try {
        ...
        '$zadanaVaha','$zadanaVyska','$zadanaAdresa','$zadaneMesto','$zadanyStat','$zadanePSC','$zadanePohlavi')";
        $result = pg_query($sql);
  ...
  <form action="" method="get">
    ...
    <div class="form-group">
      ...
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="inlineRadio1">Muži</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="žena">
        <label class="form-check-label" for="inlineRadio2">Ženy</label>
      </div>
    </div>
